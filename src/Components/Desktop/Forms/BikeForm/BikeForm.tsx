...
const BikeForm: React.FC<Props> = ({
    ...
    console.log(quoteFields.claimed.value)
    ...
    useEffect(()=>{console.log(quoteFields.claimed.value)},[quoteFields.claimed.value])
                    ...
                    <Box className="modalContent">
                        <Grid container alignItems="center">
                            <Grid xs={10}>
                                <h2 className="title_lg">
                                    ...
                                    Two-Wheeler<span> Insurance</span>
                                </h2>
                            </Grid>
                        ...
                        <Grid container spacing={3}>
                            <Grid xs={12} textAlign="center" className="mt-4">
                                <Link className="newlink" onClick={handleClick}>{show === true ? "Bought a New Two-wheeler!" : "Old Two-Wheeler!"}</Link>
                            </Grid>
                        </Grid>
                    </Box>
                </div>
